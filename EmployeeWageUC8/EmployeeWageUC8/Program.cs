...
namespace EmployeeWageUC7
{
    class Program
    {
        ...
        public static int ComputeEmpWage(string company,int Emp_Wage_Per_Hour,int Num_Of_Working_Days, int Max_Hours_Per_Month )
        {
        ...
        {
            ComputeEmpWage("Apple",20,20,100);
            ComputeEmpWage("Raymond", 20, 10, 50);
        }
    }
}
